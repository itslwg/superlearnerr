...
** TODO Add informed consent no as exclusion criteria                :todo30:
** TODO Add learners to superlearner library                         :todo31:
#+END_SRC
* Issues
#+BEGIN_SRC org
** INPROGRESS Table of sample characteristics do not display properly :issue1:
   CLOCK: [2018-05-18 Fri 11:01]
#+END_SRC
