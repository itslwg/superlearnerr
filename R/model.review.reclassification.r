                                          ...
                                          )
{
    ...
    reclassification_objs <- lapply(model_names,
                                    function(model)
                                        nricens::nribin(event = study_sample[[outcome_name]],
    ...
    reclassification_lsts <- lapply(setNames(reclassification_objs, nm = model_names),
                                    function (obj) {
