...
% Points to add:
% - Delays in care cause mortality
% Yeboah D, Mock C, Karikari P, Agyei-Baffour P, Donkor P, Ebel B. Minimizing
% preventable trauma deaths in a limited-resource setting: A test-case of a
% multidisciplinary panel review approach at the Komfo Anokye Teaching Hospital in
% Ghana. World J Surg. 2014;38(7):1707–12.
% O’Reilly D, Mahendran K, West A, Shirley P, Walsh M, Tai N. Opportunities for
% improvement in the management of patients who die from haemorrhage after
% trauma. Br J Surg. 2013;100:749–55.
% Roy N, Veetil DK, Khajanchi MU, Kumar V, Solomon H, Kamble J, et al. Learning
% from 2523 trauma deaths in India- opportunities to prevent in-hospital
% deaths. BMC Health Serv Res. 2017;17(142):1–8.
% - Better prioritisation may reduce those deaths
